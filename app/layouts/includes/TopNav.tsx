...
export default function TopNav() {
    ...
    return (
        <>
            <div id="TopNav" className="fixed bg-[rgb(20,20,20)] z-30 items-center w-full border-b h-[60px]">
                ...
                <Link href="/">
                    ...
                    <div className="relative hidden md:flex items-center justify-end bg-[rgb(56,56,56)] p-1 rounded-full max-w-[430px] w-full">
                            <input 
                                type="text"
                    ...
                    <div className="absolute bg-[rgb(56,56,56)] max-w-[910px] h-auto w-full z-20 left-0 top-12 border-gray-800 p-1">
                        <div className="p-1">
                            <Link
                            href={`/profile/1`}
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <div className="truncate ml-2">Jim Goods</div>
                                </div>
                            </Link>
                        </div>
                    </div>
                    
                    <div className="px-3 py-1 flex items-center border-l border-l-gray-800">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            onClick={() => goTo()}
                            className="flex items-center py-[6px] px-3"

                        >
                        <span className="flex items-center text-[#848484] hover:text-gray-300">
...
// make a feature where you bet on it the somehow and you can use it to buy a free beat or something or no ads or 
